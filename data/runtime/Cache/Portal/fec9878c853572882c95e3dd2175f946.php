...
<link rel="shortcut icon" href="/tpl/bs/Public/favicon.ico" type="image/x-icon" />
       ...
       <?php if(is_array($terms)): foreach($terms as $key=>$vo): ?><li><a href='/list/index/id/<?php echo ($vo["term_id"]); ?>'><?php echo ($vo["name"]); ?></a> </li><?php endforeach; endif; ?>
		...
		<div class="wp">
			<div class="tit clearfix">
				<img class="titico fl" src="/tpl/bs/Public/Pic/20140513030427493.png" alt="" />
...
<p class="deta">全面替代瓷砖和其他材料，安装方便，使用寿命长、不生锈、抗撞击，而且采用特殊工艺涂覆高性能抗菌涂层具有杀菌、除臭、自净、防霉、抗紫外线、抗风沙、防潮湿等卓越特性。</p>							</div>
	...
	<li>
		<p>
			<img border="0" data-pinit="registered" hspace="0" src="/tpl/bs/Public/Pic/20140514015800380.png" style="float:none;" title="取代.png" vspace="0" /></p>
		<p class="tit">
			取代性强</p>
		<p class="detals">
	...
	<li>
		<p>
			<img border="0" data-pinit="registered" hspace="0" src="/tpl/bs/Public/Pic/20140514015834678.png" style="float:none;" title="杀菌.png" vspace="0" /></p>
		<p class="tit">
			杀菌防霉</p>
		<p class="detals">
	...
	<li>
		<p>
			<img border="0" data-pinit="registered" hspace="0" src="/tpl/bs/Public/Pic/20140514015904870.png" style="float:none;" title="可靠性.png" vspace="0" /></p>
		<p class="tit">
			可靠性强</p>
		<p class="detals">
	...
	<li>
		<p>
			<img border="0" data-pinit="registered" hspace="0" src="/tpl/bs/Public/Pic/20140514015933392.png" style="float:none;" title="装饰性.png" vspace="0" /></p>
		<p class="tit">
			装饰性强</p>
		<p>
...
<script charset="UTF-8" id="huaban_script" src="/tpl/bs/Public/Js/widgets.min.js" type="text/javascript">
</script>
</section>								
